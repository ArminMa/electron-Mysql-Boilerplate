# electron-boilerplate Create The app
#####create a mysql schema called:
____________  electrondb ____________
 
 npm install
  
 npm run start

#####if you want to build executable installer.
npm run build

npm run release

######this app is based on electron-boilerplate
